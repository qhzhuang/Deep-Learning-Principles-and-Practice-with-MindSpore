...
Before studying this course, you need to master:
...
The main environmental information is as follows:
...
This repository is updated in sync with [MindSpore](https://www.mindspore.cn/install), New releases of this repository are published approximately every **six months**.

| Branch/Version  | Python | MindSpore |
| :----- |:-------|:----------|
| master | \>=3.9 | 2.7.1     | 
...
See the [FAQ](https://github.com/mindspore-lab/Deep-Learning-Principles-and-Practice-with-MindSpore/wiki/FAQ) in the Wiki。

## Contributing

We welcome bug reports, suggestions, and code contributions via [Issue](https://github.com/mindspore-lab/Deep-Learning-Principles-and-Practice-with-MindSpore/issues) or [PR](https://github.com/mindspore-courses/Deep-Learning-Principles-and-Practice-with-MindSpore/pulls). Please follow our submission guidelines — all PRs are reviewed and merged by @username. Your contributions make the project stronger!

### Guidelines
 
[Issue & PR Submission](https://github.com/mindspore-lab/Deep-Learning-Principles-and-Practice-with-MindSpore/wiki/%E6%8F%90%E4%BA%A4%E8%AF%B4%E6%98%8E)
...
<div align=center style="margin-top: 30px;">
  <a href="https://github.com/mindspore-lab/Deep-Learning-Principles-and-Practice-with-MindSpore/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=mindspore-lab/Deep-Learning-Principles-and-Practice-with-MindSpore" />
  </a>
</div>
